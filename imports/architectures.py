def get_architecture(p):
    ...
    layers.append({"type":"conv", "in_channels":in_channels, "out_channels":20, "kernel_size":p["kernel_size"], "stride":1, "padding": int(p["kernel_size"]/2)})
    layers.append({"type":"leaky_relu", "slope":p["leaky_slope"]})
    layers.append({"type":"pool", "kernel_size":2, "stride":2, "padding": 0})
    layers.append({"type":"conv", "in_channels":20, "out_channels":40, "kernel_size":p["kernel_size"], "stride":1, "padding": int(p["kernel_size"]/2)})
    layers.append({"type":"leaky_relu", "slope":p["leaky_slope"]})
    layers.append({"type":"pool", "kernel_size":2, "stride":2, "padding": 0})
    layers.append({"type":"conv", "in_channels":40, "out_channels":60, "kernel_size":p["kernel_size"], "stride":1, "padding": int(p["kernel_size"]/2)})
    layers.append({"type":"leaky_relu", "slope":p["leaky_slope"]})
    layers.append({"type":"pool", "kernel_size":2, "stride":2, "padding": 0})

    layers.append({"type":"flatten"})
    layers.append({"type":"fc", "in_features":8*8*60, "out_features":500})
    layers.append({"type":"leaky_relu", "slope":p["leaky_slope"]})
    layers.append({"type":"fc", "in_features":500, "out_features":100})
    layers.append({"type":"leaky_relu", "slope":p["leaky_slope"]})
    layers.append({"type":"fc", "in_features":100, "out_features":1})
    layers.append({"type":"leaky_relu", "slope":p["leaky_slope"]})
